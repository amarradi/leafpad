...
public class TranslationThanksBuilder {
    ...
    public static CharSequence build(Context context) {
        ...
        builder.append(context.getString(R.string.country_title_translator_chinese_traditional_han_script)).append("\n");
        ...
        appendBoldCountry(builder, context.getString(R.string.country_title_danish));
        builder.append(context.getString(R.string.country_title_translator_danish)).append("\n");
        appendBoldCountry(builder, context.getString(R.string.country_title_dutch));
        builder.append(context.getString(R.string.country_title_translator_dutch)).append("\n");
        ...
        appendBoldCountry(builder, context.getString(R.string.country_title_gothic));
        builder.append(context.getString(R.string.country_title_translator_gothic)).append("\n");
        ...
        appendBoldCountry(builder, context.getString(R.string.country_title_polish));
        builder.append(context.getString(R.string.country_title_translator_polish)).append("\n");
